...
static void Run(NSString *scenario){
    ...
    r.update=^(NSString *text,BOOL final,NSString *e){if(final){done=YES;finals++;error=e;}if([scenario isEqual:@"cancel-before"]&&[text containsString:@"正在创建并核对日程或待办"]){[weak cancel];done=YES;}};
